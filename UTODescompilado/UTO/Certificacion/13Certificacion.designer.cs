...
// Type: UTO.Certificacion.spConsultaTecnicoResult
...
{
  public class spConsultaTecnicoResult
  {
    ...
    [Column(Storage = "_AreaTrabajo", DbType = "VarChar(70)")]
    ...
    [Column(Storage = "_Categoria", DbType = "VarChar(75)")]
