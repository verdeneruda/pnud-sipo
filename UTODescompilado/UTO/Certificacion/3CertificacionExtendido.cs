...
// Type: UTO.Certificacion.mun_Municipio
...
namespace UTO.Certificacion
{
    ...
    INotifyPropertyChanged
  {
    ...
    public mun_Municipio()
    {
      ...
      this._act_Actividads = new EntitySet<act_Actividad>(new Action<act_Actividad>(this.attach_act_Actividads), new Action<act_Actividad>(this.detach_act_Actividads));
    ...
    [Association(Name = "mun_Municipio_act_Actividad", Storage = "_act_Actividads", ThisKey = "mun_Id", OtherKey = "mun_Id")]
