...
// Type: UTO.Recuperacion.ter_Tercero
...
namespace UTO.Recuperacion
{
  ...
  public class ter_Tercero : INotifyPropertyChanging, INotifyPropertyChanged
  {
    ...
    [Column(Storage = "_ter_Rut", DbType = "VarChar(20)")]
    public string ter_Rut
    {
      get => this._ter_Rut;
      set
      {
        if (!(this._ter_Rut != value))
          return;
        this.SendPropertyChanging();
        this._ter_Rut = value;
        this.SendPropertyChanged(nameof (ter_Rut));
      }
    }
    ...
    [Association(Name = "ter_Tercero_rdu_ReporteUso", Storage = "_rdu_ReporteUsos", ThisKey = "ter_Id", OtherKey = "ter_Id")]
    ...
    [Association(Name = "ter_Tercero_rre_ReporteRegeneracion", Storage = "_rre_ReporteRegeneracions", ThisKey = "ter_Id", OtherKey = "ter_Id")]
    ...
    [Association(Name = "ter_Tercero_seq_SolicitudEquipo", Storage = "_seq_SolicitudEquipos", ThisKey = "ter_Id", OtherKey = "ter_Id")]
    ...
    [Association(Name = "ter_Tercero_rdb_ReporteUsoBarrido", Storage = "_rdb_ReporteUsoBarridos", ThisKey = "ter_Id", OtherKey = "ter_Id")]
