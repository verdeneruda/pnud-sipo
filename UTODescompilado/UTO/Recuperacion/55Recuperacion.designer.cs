...
// Type: UTO.Recuperacion.spConsultaNovedadResult
...
{
  public class spConsultaNovedadResult
  {
    private int _Id;
    ...
    [Column(Name = "[Causa novedad]", Storage = "_Causa_novedad", DbType = "VarChar(30)")]
    public string Causa_novedad
    {
      get => this._Causa_novedad;
      set
      {
        if (!(this._Causa_novedad != value))
          return;
        this._Causa_novedad = value;
      }
    }
  }
}
