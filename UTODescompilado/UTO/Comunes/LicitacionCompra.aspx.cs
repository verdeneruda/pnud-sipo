...
// Type: UTO.Comunes.LicitacionCompra
...
{
  public class LicitacionCompra : BaseModulo
  {
    ...
    protected void LinkNuevo_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        sqlCommand.CommandText = "select max(lco_Id) from [Rrr].[lco_LicitacionCompra]";
        sqlCommand.Connection.Open();
        this.SqlDataCatalogo.InsertParameters["lco_Id"].DefaultValue = ((int) sqlCommand.ExecuteScalar() + 1).ToString();
        this.SqlDataCatalogo.InsertParameters["lco_Descripcion"].DefaultValue = "Nueva descripcion";
        this.SqlDataCatalogo.InsertParameters["pre_Id"].DefaultValue = "1";
    ...
    protected void gridCatalogo_RowCommand(object sender, GridViewCommandEventArgs e)
    {
      ...
      try
      {
        ...
        this.SqlDataCatalogo.DeleteParameters["lco_Id"].DefaultValue = int.Parse(this.gridCatalogo.DataKeys[int.Parse((string) e.CommandArgument) - pageIndex * pageSize].Value.ToString()).ToString();
