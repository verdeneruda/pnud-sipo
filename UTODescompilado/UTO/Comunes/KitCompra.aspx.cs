...
{
  public class KitCompra : BaseModulo
  {
    ...
    protected void LinkNuevo_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        sqlCommand.CommandText = "select max(kco_Id) from [Rrr].[kco_KitCompra]";
        sqlCommand.Connection.Open();
        this.SqlDataCatalogo.InsertParameters["kco_Id"].DefaultValue = ((int) sqlCommand.ExecuteScalar() + 1).ToString();
        this.SqlDataCatalogo.InsertParameters["kco_Descripcion"].DefaultValue = "Nueva descripcion";
        this.SqlDataCatalogo.InsertParameters["lco_Id"].DefaultValue = "1";
    ...
    protected void gridCatalogo_RowCommand(object sender, GridViewCommandEventArgs e)
    {
      ...
      try
      {
        ...
        this.SqlDataCatalogo.DeleteParameters["kco_Id"].DefaultValue = int.Parse(this.gridCatalogo.DataKeys[int.Parse((string) e.CommandArgument) - pageIndex * pageSize].Value.ToString()).ToString();
