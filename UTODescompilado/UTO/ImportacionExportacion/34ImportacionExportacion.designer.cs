...
// Type: UTO.ImportacionExportacion.spConsultaVistoBuenoImportacionResult
...
{
  public class spConsultaVistoBuenoImportacionResult
  {
    private int _Id;
    ...
    [Column(Storage = "_Exportador", DbType = "VarChar(150)")]
