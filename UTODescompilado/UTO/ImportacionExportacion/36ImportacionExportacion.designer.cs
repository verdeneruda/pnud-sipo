...
// Type: UTO.ImportacionExportacion.spConsultaVistoBuenoExportacionResult
...
{
  public class spConsultaVistoBuenoExportacionResult
  {
    private int _Id;
    ...
    [Column(Storage = "_Exportador", DbType = "VarChar(450)")]
