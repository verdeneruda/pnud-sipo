...
// Type: UTO.RegistrosUso.mun_Municipio
...
namespace UTO.RegistrosUso
{
    ...
    IComparable<mun_Municipio>
  {
    ...
    [Association(Name = "mun_Municipio_ufd_UsuarioFinalDato", Storage = "_ufd_UsuarioFinalDatos", ThisKey = "mun_Id", OtherKey = "mun_Id")]
    ...
    [Association(Name = "mun_Municipio_rid_RegistroImportadorDetalle", Storage = "_rid_RegistroImportadorDetalles", ThisKey = "mun_Id", OtherKey = "mun_Id")]
