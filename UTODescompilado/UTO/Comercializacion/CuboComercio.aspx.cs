...
// Type: UTO.Comercializacion.CuboComercio
...
{
  public class CuboComercio : System.Web.UI.Page
  {
    ...
    protected PivotGridField fieldPresentacion;
    protected PivotGridField fieldDepartamento;
    protected PivotGridField fieldCiudad;
    protected PivotGridField fieldPrecioPromedio;
    protected PivotGridField fieldAo;
    protected PivotGridField fieldComerciante;
    protected Button ButtonVolver;
    protected Button buttonExportar;
    protected SqlDataSource dsComercio;
    ...
    protected void buttonExportar_Click(object sender, EventArgs e)
    {
      ...
      using (MemoryStream memoryStream = new MemoryStream())
      {
        ...
        this.Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", (object) "CuboCertificacion", (object) str));
