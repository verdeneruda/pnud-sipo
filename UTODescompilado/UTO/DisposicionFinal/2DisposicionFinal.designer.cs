...
// Type: UTO.DisposicionFinal.dep_Departamento
...
namespace UTO.DisposicionFinal
{
    ...
    IComparable<dep_Departamento>
  {
    ...
    [Association(Name = "dep_Departamento_dfd_DisposicionFinalDato", Storage = "_dfd_DisposicionFinalDatos", ThisKey = "dep_Id", OtherKey = "dep_Id")]
