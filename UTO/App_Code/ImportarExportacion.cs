...
/// <summary>
/// Descripción breve de ImportarExportacion
/// </summary>
public class ImportarExportacion
{
    ImportacionExportacionDataContext MyDataContext;
    public Stream bytArchivo { get; set; }
    string respuesta = "";
    public DataTable dtRegistros { get; set; }
    public CUsuario Usuario { get; set; }
    public ImportarExportacion(Stream bteArchivo, ImportacionExportacionDataContext myDataContext, CUsuario cUsuario)
    {
        this.bytArchivo = bteArchivo;
        this.Usuario = cUsuario;
        MyDataContext = myDataContext;
        dtRegistros = new DataTable();
        dtRegistros.Columns.Add("NroRegistro");
        dtRegistros.Columns.Add("Ano");
        dtRegistros.Columns.Add("Mes");
        dtRegistros.Columns.Add("Dia");
        dtRegistros.Columns.Add("NumeroDeclaracionDefinitiva");
        dtRegistros.Columns.Add("Aduana");
        dtRegistros.Columns.Add("AgenteAduanero");
        dtRegistros.Columns.Add("RazonSocialExportador");
        dtRegistros.Columns.Add("RazonSocialImportador");
        dtRegistros.Columns.Add("DireccionImportacion");
        dtRegistros.Columns.Add("CodigoPartida", typeof(int));
        dtRegistros.Columns.Add("UnidadComercial", typeof(int));
        dtRegistros.Columns.Add("Cantidad");
        dtRegistros.Columns.Add("PesoKilos", typeof(int));
        dtRegistros.Columns.Add("PaisDestino", typeof(int));
        dtRegistros.Columns.Add("ValorFOB", typeof(decimal));
        dtRegistros.Columns.Add("PrecioUnitarioFOB", typeof(decimal));
