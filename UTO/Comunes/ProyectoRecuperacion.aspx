<%@ Page Language="C#" MasterPageFile="~/MPMain.Master"  AutoEventWireup="true" CodeBehind="ProyectoRecuperacion.aspx.cs" Inherits="UTO.Comunes.ProyectoRecuperacion" %>
        ...
        <cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
            ...
            <div class="divwithoutgrid">
                <table class="titulo" >
                    <tr>
                        <td>
                            <asp:Label ID="labelPais" runat="server" Text="Proyectos" CssClass="subtitulo"></asp:Label>
                        </td>
                    </tr>
                </table>
                                    ...
                                    <td>
                                       <%-- <asp:Panel ID="PanelBuscarTercero" runat="server" Width="671px">
                                            ...
                                            AutoGenerateColumns="False" CssClass="grilla" 
                                                            DataKeyNames="pre_Id" DataSourceID="SqlDataCatalogo" 
                                            ...
                                            AllowPaging="True" PageSize="15" onrowcommand="gridCatalogo_RowCommand">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:BoundField DataField="pre_Id" HeaderText="Id" ReadOnly="True" 
                                                                    SortExpression="pre_Id" />
                                                                <asp:BoundField DataField="pre_Descripcion" HeaderText="Proyecto" 
                                                                    SortExpression="pre_Descripcion" />
                                                            </Columns>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataCatalogo" runat="server" 
                                                            ...
                                                            DeleteCommand="DELETE FROM [Rrr].[pre_ProyectoRecuperacion] WHERE [pre_Id] = @pre_Id" 
                                                            InsertCommand="INSERT INTO [Rrr].[pre_ProyectoRecuperacion] ([pre_Id], [pre_Descripcion]) VALUES (@pre_Id, @pre_Descripcion)" 
                                                            SelectCommand="SELECT pre_Id, pre_Descripcion FROM [Rrr].pre_ProyectoRecuperacion" 
                                                            UpdateCommand="UPDATE [Rrr].[pre_ProyectoRecuperacion] SET [pre_Descripcion] = @pre_Descripcion WHERE [pre_Id] = @pre_Id">
                                                            <DeleteParameters>
                                                                <asp:Parameter Name="pre_Id" Type="Int32" />
                                                            </DeleteParameters>
                                                            <UpdateParameters>
                                                                <asp:Parameter Name="pre_Descripcion" Type="String" />
                                                                <asp:Parameter Name="pre_Id" Type="Int32" />
                                                            </UpdateParameters>
                                                            <InsertParameters>
                                                                <asp:Parameter Name="pre_Id" Type="Int32" />
                                                                <asp:Parameter Name="lpre_Descripcion" Type="String" />
                                                            </InsertParameters>
                                                        </asp:SqlDataSource>
                                                    <%--</td>
                                                    <td class="separador">
