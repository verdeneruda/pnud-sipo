<%@ Page Language="C#" MasterPageFile="~/MPMain.Master"  AutoEventWireup="true" CodeBehind="TipoEquipo.aspx.cs" Inherits="UTO.Comunes.TipoEquipo" %>
    ...
    <div class="divwithoutgrid">
        ...
        <table class="titulo" >
            <tr>
                <td>
                    <asp:Label ID="labelPais" runat="server" Text="Tipo equipo uso" CssClass="subtitulo"></asp:Label>
                </td>
            </tr>
        </table>
                            ...
                            <td>
                                <%--<asp:Panel ID="PanelBuscarTercero" runat="server" Width="671px">
                                    ...
                                    AutoGenerateColumns="False" CssClass="grilla" 
                                                    DataKeyNames="eti_Id" DataSourceID="SqlDataCatalogo" 
                                    ...
                                    AllowPaging="True" PageSize="15" onrowcommand="gridCatalogo_RowCommand">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="eti_Id" HeaderText="Id" ReadOnly="True" 
                                                            SortExpression="eti_Id" />
                                                        <asp:BoundField DataField="eti_Descripcion" HeaderText="Tipo equipo" 
                                                            SortExpression="eti_Descripcion" />
                                                    </Columns>
                                                ...
                                                <asp:SqlDataSource ID="SqlDataCatalogo" runat="server" 
                                                    ...
                                                    DeleteCommand="DELETE FROM [Rus].[eti_EquipoTipo] WHERE [eti_Id] = @eti_Id" 
                                                    InsertCommand="INSERT INTO [Rus].[eti_EquipoTipo] ([eti_Id], [eti_Descripcion]) VALUES (@eti_Id, upper(@eti_Descripcion))" 
                                                    SelectCommand="SELECT eti_Id, eti_Descripcion FROM [Rus].eti_EquipoTipo" 
                                                    UpdateCommand="UPDATE [Rus].[eti_EquipoTipo] SET [eti_Descripcion] = upper(@eti_Descripcion) WHERE [eti_Id] = @eti_Id">
                                                    <DeleteParameters>
                                                        <asp:Parameter Name="eti_Id" Type="Int32" />
                                                    </DeleteParameters>
                                                    <UpdateParameters>
                                                        <asp:Parameter Name="eti_Descripcion" Type="String" />
                                                        <asp:Parameter Name="eti_Id" Type="Int32" />
                                                    </UpdateParameters>
                                                    <InsertParameters>
                                                        <asp:Parameter Name="eti_Id" Type="Int32" />
