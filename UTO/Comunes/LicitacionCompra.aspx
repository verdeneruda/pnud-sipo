<%@ Page Language="C#" MasterPageFile="~/MPMain.Master"  AutoEventWireup="true" CodeBehind="LicitacionCompra.aspx.cs" Inherits="UTO.Comunes.LicitacionCompra" %>
        ...
        <cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
            ...
            <div class="divwithoutgrid">
                <table class="titulo" >
                    <tr>
                        <td>
                            <asp:Label ID="labelPais" runat="server" Text="Compra licitación" CssClass="subtitulo"></asp:Label>
                        </td>
                    </tr>
                </table>
                                    ...
                                    <td>
                                       <%-- <asp:Panel ID="PanelBuscarTercero" runat="server" Width="671px">
                                            ...
                                            AutoGenerateColumns="False" CssClass="grilla" 
                                                            DataKeyNames="lco_Id" DataSourceID="SqlDataCatalogo" 
                                            ...
                                            AllowPaging="True" PageSize="15" onrowcommand="gridCatalogo_RowCommand">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:BoundField DataField="lco_Id" HeaderText="Id" ReadOnly="True" 
                                                                    SortExpression="lco_Id" />
                                                                <asp:BoundField DataField="lco_Descripcion" HeaderText="Licitación" 
                                                                    SortExpression="lco_Descripcion" />
                                                                <asp:BoundField DataField="pre_Id" HeaderText="Id proyecto" 
                                                                    SortExpression="pre_Id" />                                                                    
                                                            </Columns>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataCatalogo" runat="server" 
                                                            ...
                                                            DeleteCommand="DELETE FROM [Rrr].[lco_LicitacionCompra] WHERE [lco_Id] = @lco_Id" 
                                                            InsertCommand="INSERT INTO [Rrr].[lco_LicitacionCompra] ([lco_Id], [lco_Descripcion],[pre_Id]) VALUES (@lco_Id, @lco_Descripcion,@pre_Id)" 
                                                            SelectCommand="SELECT lco_Id, lco_Descripcion,pre_Id FROM [Rrr].lco_LicitacionCompra" 
                                                            UpdateCommand="UPDATE [Rrr].[lco_LicitacionCompra] SET [lco_Descripcion] = @lco_Descripcion,[pre_Id]=@pre_Id WHERE [lco_Id] = @lco_Id">
                                                            <DeleteParameters>
                                                                <asp:Parameter Name="lco_Id" Type="Int32" />
                                                            </DeleteParameters>
                                                            <UpdateParameters>
                                                                <asp:Parameter Name="lco_Descripcion" Type="String" />
                                                                <asp:Parameter Name="lco_Id" Type="Int32" />
