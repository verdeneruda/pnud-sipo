<%@ Page Language="C#" MasterPageFile="~/MPMain.Master"  AutoEventWireup="true" CodeBehind="GasUso.aspx.cs" Inherits="UTO.Comunes.GasUso" %>
    ...
    <div class="divwithoutgrid">
        <table class="titulo" >
            <tr>
                <td>
                    <asp:Label ID="labelPais" runat="server" Text="Uso del gas" CssClass="subtitulo"></asp:Label>
                </td>
            </tr>
        </table>
                            ...
                            <td>
                                <%--<asp:Panel ID="PanelBuscarTercero" runat="server" Width="671px">
                                    ...
                                    AutoGenerateColumns="False" CssClass="grilla" 
                                                    DataKeyNames="gus_Id" DataSourceID="SqlDataCatalogo" 
                                    ...
                                    AllowPaging="True" PageSize="15" onrowcommand="gridCatalogo_RowCommand">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="gus_Id" HeaderText="Id" ReadOnly="True" 
                                                            SortExpression="gus_Id" />
                                                        <asp:BoundField DataField="gus_Descripcion" HeaderText="Uso gas" 
                                                            SortExpression="gus_Descripcion" />
                                                    </Columns>
                                                ...
                                                <asp:SqlDataSource ID="SqlDataCatalogo" runat="server" 
                                                    ...
                                                    DeleteCommand="DELETE FROM [Rrr].[gus_GasUso] WHERE [gus_Id] = @gus_Id" 
                                                    InsertCommand="INSERT INTO [Rrr].[gus_GasUso] ([gus_Id], [gus_Descripcion]) VALUES (@gus_Id, upper(@gus_Descripcion))" 
                                                    SelectCommand="SELECT gus_Id, gus_Descripcion FROM [Rrr].gus_GasUso" 
                                                    UpdateCommand="UPDATE [Rrr].[gus_GasUso] SET [gus_Descripcion] = upper(@gus_Descripcion) WHERE [gus_Id] = @gus_Id">
                                                    <DeleteParameters>
                                                        <asp:Parameter Name="gus_Id" Type="Int32" />
                                                    </DeleteParameters>
                                                    <UpdateParameters>
                                                        <asp:Parameter Name="gus_Descripcion" Type="String" />
                                                        <asp:Parameter Name="gus_Id" Type="Int32" />
                                                    </UpdateParameters>
                                                    <InsertParameters>
                                                        <asp:Parameter Name="gus_Id" Type="Int32" />
