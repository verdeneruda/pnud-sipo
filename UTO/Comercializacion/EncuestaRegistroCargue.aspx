<%@ Page Title="" Language="C#" MasterPageFile="~/MPMain.Master" AutoEventWireup="true" CodeFile="EncuestaRegistroCargue.aspx.cs" Inherits="Comercializacion_EncuestaRegistroCargue" %>
    ...
    <cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></cc1:ToolkitScriptManager>
     <div class="divwithoutgrid">
         <table class="titulo">
             <tr>
                 <td>
                     <asp:Label ID="labelAdicionarEncuesta" runat="server" Text="Módulo de seguimiento al comercio local de SAO - Impotar datos de comercialización" CssClass="subtitulo"></asp:Label>
                 </td>
             </tr>
         </table>
         <table class="form">
