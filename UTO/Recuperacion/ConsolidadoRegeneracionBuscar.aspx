<%@ Page Language="C#" MasterPageFile="~/MPMain.Master"  AutoEventWireup="true" CodeBehind="ConsolidadoRegeneracionBuscar.aspx.cs" Inherits="UTO.Recuperacion.ConsolidadoRegeneracionBuscar" %>
    ...
    <table class="titulo" >
        <tr><td>
        <asp:Label ID="labelBusquedaSolicitudesEquipos" runat="server" Text="Proyectos de dotación de equipos y herramientas  para el sector de refrigeración y aire acondicionado - Centros de regeneración - Buscar reporte consolidado regeneración" CssClass="subtitulo"></asp:Label>
        </td></tr>
    </table>
    <table class="form">
    <tr>
    ...
    FooterStyle-CssClass="footergrilla" onrowcommand="gridBuscarReporteUso_RowCommand" 
            ...
            DataSourceID="consolidadoRegeneracionBuscarDataSource" PageSize="15" 
    ...
    <HeaderStyle CssClass="headergrilla"></HeaderStyle>
        ...
        <asp:SqlDataSource ID="consolidadoRegeneracionBuscarDataSource" runat="server" 
            ConnectionString="<%$ ConnectionStrings:BDUTOConnectionString %>" 
            SelectCommand="exec [Rrr].[spReporteCentroConsolidadoBuscar] @centro,@fechaInicial,@fechaFinal">
            <SelectParameters>
