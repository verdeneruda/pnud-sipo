<%@ Page Language="C#" MasterPageFile="~/MPPivot.Master" AutoEventWireup="true" CodeBehind="CuboBarrido.aspx.cs" Inherits="UTO.Recuperacion.CuboBarrido" %>
    ...
    <tr>
        <td>
            <dx:ASPxPivotGrid ID="ASPxPivotGrid3" runat="server" 
                ...
                <Fields>
                    ...
                    <dx:PivotGridField ID="CentroField" AreaIndex="1" FieldName="DescripcionN" AllowedAreas="RowArea,ColumnArea,FilterArea"  Caption="Tipo de mantenimiento nitrógeno">
                    </dx:PivotGridField>
                    <dx:PivotGridField ID="SustanciaField" AreaIndex="2" FieldName="DescripcionF" AllowedAreas="RowArea,ColumnArea,FilterArea" Caption="Tipo de mantenimiento filtro">
                    </dx:PivotGridField>
                    <dx:PivotGridField ID="DestinoField" AreaIndex="3" FieldName="DescripcionA" AllowedAreas="RowArea,ColumnArea,FilterArea" Caption="Tipo de mantenimiento test acidez">
                    </dx:PivotGridField>
                    <dx:PivotGridField ID="fieldCantidad" AreaIndex="0" FieldName="rdb_NitrogenoCilindro" AllowedAreas="DataArea"  GrandTotalCellFormat-FormatString="#,##0" TotalValueFormat-FormatType="Numeric" GrandTotalCellFormat-FormatType="Numeric" CellFormat-FormatType="Numeric" Caption="Cantidad cilindros">
                    </dx:PivotGridField>
                    <dx:PivotGridField ID="PivotGridField1" AreaIndex="1" FieldName="rdb_NitrogenoKilo" AllowedAreas="DataArea"  GrandTotalCellFormat-FormatString="#,##0.##" TotalValueFormat-FormatType="Numeric" GrandTotalCellFormat-FormatType="Numeric" CellFormat-FormatType="Numeric" Caption="Cantidad nitrógeno">
                    </dx:PivotGridField>
                    <dx:PivotGridField ID="PivotGridField2" AreaIndex="2" FieldName="rdb_FiltroUnidad" AllowedAreas="DataArea"  GrandTotalCellFormat-FormatString="#,##0" TotalValueFormat-FormatType="Numeric" GrandTotalCellFormat-FormatType="Numeric" CellFormat-FormatType="Numeric" Caption="Cantidad filtros">
                    </dx:PivotGridField>
                    <dx:PivotGridField ID="PivotGridField3" AreaIndex="3" FieldName="rdb_AcidezUnidad" AllowedAreas="DataArea"  GrandTotalCellFormat-FormatString="#,##0" TotalValueFormat-FormatType="Numeric" GrandTotalCellFormat-FormatType="Numeric" CellFormat-FormatType="Numeric" Caption="Cantidad test acidez">
                    </dx:PivotGridField>                                                            
                </Fields>                
      ...
      <dx:ASPxPivotGridExporter ID="pivotExport3" runat="server" ASPxPivotGridID="ASPxPivotGrid2">
            ...
            <asp:SqlDataSource ID="SqlDataCuboEquipos" runat="server" 
                ...
                SelectCommand="Exec [Rrr].[spCuboReporteBarrido] "></asp:SqlDataSource>
    ...
    <tr>
      ...
      <dx:ASPxPivotGridExporter ID="pivotExport1" runat="server" ASPxPivotGridID="ASPxPivotGrid1">
            ...
            <asp:SqlDataSource ID="SqlDataEquipos" runat="server" 
                ConnectionString="<%$ ConnectionStrings:BDUTOConnectionString %>" 
                SelectCommand="Exec [Rrr].[spCuboEquipos] 2 "></asp:SqlDataSource>        
        </td>
       </tr>
       </table>
       </asp:Panel>    
