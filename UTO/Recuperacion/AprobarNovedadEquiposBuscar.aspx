<%@ Page Language="C#" MasterPageFile="~/MPMain.Master"  AutoEventWireup="true" CodeBehind="AprobarNovedadEquiposBuscar.aspx.cs" Inherits="UTO.Recuperacion.AprobarNovedadEquiposBuscar" %>
    ...
    FooterStyle-CssClass="footergrilla" 
            ...
            AllowPaging="True" DataSourceID="aprobarNovedadEquiposBuscarDataSource" 
    ...
    <RowStyle CssClass="rowgrilla"></RowStyle>
        <Columns>
            ...
            <asp:BoundField DataField="Fecha novedad" HeaderText="Fecha novedad" 
                SortExpression="Fecha novedad" DataFormatString="{0:d/M/yyyy}" />
    ...
    <HeaderStyle CssClass="headergrilla"></HeaderStyle>
        ...
        <asp:SqlDataSource ID="aprobarNovedadEquiposBuscarDataSource" runat="server" 
